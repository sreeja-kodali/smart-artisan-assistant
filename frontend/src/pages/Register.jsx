    ...
    <div className="min-h-screen bg-artisan-cream flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white p-8 rounded-3xl shadow-xl border border-artisan-olive/10">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold font-serif">Join the Workshop</h1>
          <p className="text-artisan-ink/60">Start tracking your artisan journey</p>
        </div>
        ...
        <p className="text-center mt-8 text-sm text-artisan-ink/60">
          Already have an account? <Link to="/login" className="text-artisan-clay font-bold underline">Log in</Link>
        </p>
      </div>
    </div>
  );
